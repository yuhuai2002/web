...
work_dir = "/root/www/zip"
extracted_path = "/root/www/unzip"
output_dir = "/root/www/output"
source = "/root/xgo/tmplate.xlsx" 
...
def process(Mawb, output_csv_dir):
    ...
    for i, file_path in enumerate(glob.glob(os.path.join(extracted_path, 'Invoice & Packing List/*.xlsx'))):
...
log_file = "/root/www/import_log.txt"
